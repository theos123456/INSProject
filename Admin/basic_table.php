...
<body>
  ...
  <?php
   $conn=mysqli_connect('localhost','root','','reservation') or die('Connection fails');
$query1=mysqli_query($conn,"select * from publication,users where users.userid=publication.userid") or die("selecting error");
  ?>
   ...
   <!------------------------------------------------------------END----------------------->
    ...
    <div class="text-right">
      <div class="credits">
          ...
          -->
          Designed by <a href="https://bootstrapmade.com/">josiane</a>
        </div>
    </div>
  </section>
