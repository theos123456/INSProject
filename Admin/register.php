...
//end of file uploads-----------------------------------------------------
 ...
 $sql0 = "UPDATE users SET fname='$first',lname='$last',location='$location',email='$email',phone='$phone',username='$username',password='$password' WHERE userid='".$_SESSION['userId']."'";
if($sql0 == true)
{
